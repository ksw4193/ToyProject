...
increased fidelity.  See the [Status] prefab in the example scene for how to set this up.  Since it uses Text,
...
GUILayer, Text, and Texture:

The recommended way for drawing 2D content is through SteamVR_Overlay.  There is an example of how to set this up
in the example scene.  Text and Texture use their Transform to determine where they are drawn, so these
...
functionality to wrap up Text display, overriding SetAlpha.
